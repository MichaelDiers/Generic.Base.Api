namespace Generic.Base.Api.Transformer
{
    ...
    ///     <typeparamref name="TEntry" />.
    /// </typeparam>
    public interface IUserBoundAtomicTransformer<in TCreateEntry, out TEntry, in TUpdateEntry>
    {
        /// <summary>
        ...
        TEntry Transform(TCreateEntry createEntry, string userId);
        ...
        /// <returns>The transformed entry of type <typeparamref name="TEntry" />.</returns>
        TEntry Transform(TUpdateEntry updateEntry, string userId, string entryId);
    }
}
